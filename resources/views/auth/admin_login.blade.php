			...
			<div class="col-12">
              ...
              <div class="box-body">
					  <div class="alert alert-success alert-dismissible">
						...
						<i class="icon fa fa-check">{{ session::get('error') }}</i>
					  </div>
					</div>
              @endif
							...
							<form method="POST" action="{{  isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" type="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
